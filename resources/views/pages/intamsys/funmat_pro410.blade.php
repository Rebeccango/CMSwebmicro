...
@section('title') Intamsys FUNMAT PRO 410 @stop
@section('meta')
<link rel="canonical" href="{{route('intamsys.funmat.pro410')}}" />
@stop
      ...
      <div class="content white-content d-flex justify-content-center align-items-center">
         <div>
            <div class="section-title parallax-section__title center-block mx-auto">
               <h1 class="wow fadeIn">FUNMAT PRO 410</h1>
               <div class="section-title-divider"></div>
               <h2 class="h3">A MULTIPLE FUNCTIONAL MATERIALS ALL-IN-ONE SOLUTION</h2>
            </div>
            <div>
      ...
      <div class="row justify-content-center align-items-center">
         <div class="d-flex align-items-center col-md-6 col-sm-12 mt-0 mt-sm-3 order-md-1 order-sm-2 order-xs-2 ">
            <img width="100%" height="auto" class="m-auto" style="margin-top:-50px; max-width:400px"
               src="{{asset('images/pages/intamsys/funmat-pro-410.png')}}" />
         </div>
         <div class="col-md-6 col-sm-12 order-md-2 order-sm-1 order-xs-1Right">
            <h2 class="h1 mb-3">FUNMAT PRO 410</h2>
            <p class="">Featuring a dual extruder and a large build chamber, the FUNMAT PRO 410 is an industrial quality
               additive manufacturing
               solution, able to print in PEEK, PEKK, PPSU, ULTEM, ABS, PC and many more functional materials.</p>
            <p>The 500°C Max. hotend temperature, 160°C Max. heatbed temperature and 90°C Max. chamber temperature,
               ensure there is no
               warping or cracking while printing, while a linear guide and a high performance oriental motor enables
               high speed and
               high precision.</p>
            <p>For an optimum comfort of use, nozzles can be cleaned automatically, a filament absence warning system is
               included,
               status are indicated by a LED system while an inside camera provides you with a live observation how the
               printing
               process.</p>
            <p><strong>Build volume:</strong> 305 x 305 x 406mm</p>
