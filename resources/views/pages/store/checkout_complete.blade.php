...
@section('title')
Checkout - Compete | CAD MicroSolutions Inc.
@stop
@section('meta')
...
@stop
@section('body')
<section style=" padding-top:0; margin-top:170px">
	<div class="container-fluid">
		<div class="col-lg-9 col-md-7 col-sm-8 col-xs-12">
			<h1 class="main-title">Order Completed</h1>
		</div>
		<div class="row">
			...
			<div class="col-lg-12 col-sm-12">
				...
				<p>
					You will receive a email confirmation for your order at: <strong>{{$order->email}}</strong> (Please check your
					spam folder).
				</p>
				@if($newUser)
				<p>
					<strong>Please follow the instructions in your confirmation email to activate your CAD MicroSolutions store
						account. This will allow you to keep a record of your orders and display up-to-date order status and tracking
				...
				View your account <a href="{{ route('orders') }}">order history</a>
				@endif
				@endif
				<p>
			...
			<div class="col-lg-12 p-0" id="shopping_cart" style="border-bottom:1px solid #ccc">
				...
				<div class="cart-items-list" style="width:100%">
					...
					<div class="cart-item" data-pid="{{$product->id}}">
						<a href="/store/catalog/{{$category->slug}}/{{$product->slug}}" title="{{$product->title}}" class="mx-auto d-block  text-center">
