...
@stop
@section('body')
<section class="parallax trans-header-window"
   style="margin-top:130px; background-image:url({{asset('/storage/banners/model-blur-header-solidworks.jpg')}}); background-position:bottom; background-size:fit; background-attachment: inherit; min-height:350px; background-color: #161616;">
            ...
            <div class="col-lg-12">
               <div class="card mb-3">
                  <p class="section-secondary p-3 m-0">
                     For additional information on the current SOLIDWORKS promotions, please give us a call or <a
                        href="#" class="btn-dialog" data-toggle="modal" data-target="#contactModal"
                        data-title="Contact an Agent">contact
                        us</a>
                  </p>
               </div>
            </div>
   ...
   <div class="modal-dialog" role="document" style="max-width:700px">
      <div class="modal-content">
         <div class="modal-header">
            <div class="modal-title h4 mt-0 w-100">Buy one, get one half off!<div class="h6"><strong>Valid through March
                     29, 2019</strong></div>
            </div>
         ...
         <div class="modal-body p-2 pr-0">
            <iframe src="https://analytics.clickdimensions.com/cadmicrocom-au6my/pages/yddzv0bheempewanojccyg.html"
               allowtransparency="true" width="100%" height="420px" type="text/html" frameborder="0"
