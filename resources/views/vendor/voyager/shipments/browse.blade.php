                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @endforeach
                                            @can('edit', app($dataType->model_name))
                                                 <a href="{{ route('voyager.'.$dataType->slug.'.create', ['copy'=>$data->id]) }}" target="_blank" class="btn btn-sm btn-success pull-right" style="margin-right:5px;" data-toggle="tooltip" title="Copy">
