...
function scrollToOffset(el) {
    var offset = 80;
    var elTop = $(el).offset().top - $(".wrap .mCSB_container").offset().top;
    return elTop - offset;
}
...
function centerObject(obj, box) {
    ...
    var cHeight = obj.outerHeight();
    var cWidth = obj.outerWidth();
    var mTop = (wHeight - cHeight) / 2;
    var mLeft = (wWidth - cWidth) / 2;

    $(obj).css('margin-top', mTop).css('margin-left', mLeft);
}
